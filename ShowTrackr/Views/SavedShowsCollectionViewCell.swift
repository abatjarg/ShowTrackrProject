//
//  SavedShowsCollectionViewCell.swift
//  ShowTrackr
//
//  Created by abatjarg on 3/22/20.
//  Copyright © 2020 abatjarg. All rights reserved.
//

import UIKit

class SavedShowsCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.topAnchor.constraint(equalTo: container.bottomAnchor, constant: 20),
